#!/usr/bin/env python3
"""Run standard (non-speculative) decoding on benchmarks."""
...
def main():
    parser = argparse.ArgumentParser(description="Run baseline decoding evaluation")
    parser.add_argument(
    ...
    for dataset_name in datasets:
        ...
        save_results(results, config.eval.output_dir, prefix=f"baseline_{dataset_name}")
